document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (input.matches('[name="name"], #name, [name="email"], #email, [name="phone"], #phone, [name="message"], #message')) {
                clearError(input);
            }
        });
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '516935ab-be88-40e9-8c7a-9bea907d61bd',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '516935ab-be88-40e9-8c7a-9bea907d61bd';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '516935ab-be88-40e9-8c7a-9bea907d61bd';
